...
public class QuestionServiceImpl implements QuestionService 
{
	...
	public QuestionFormBean getAQuestion(String userName) throws NoAdditionalQuestionAvailableException,NoAssignedQuestionException,AllAdditionalQuestionAnsweredException,Exception
	{
		...
		if(isAlreadyAnsweredCorrectly)
		{
			...
			wholeQuestion.append(" $ \\\\ $");
			optionList.put("a",additionalQuestionDTO.getOption1());
			wholeQuestion.append("a. "+additionalQuestionDTO.getOption1()+" \\newline ");
			optionList.put("b",additionalQuestionDTO.getOption2());
			wholeQuestion.append("b. "+additionalQuestionDTO.getOption2()+" \\newline ");
			optionList.put("c",additionalQuestionDTO.getOption3());
			wholeQuestion.append("c. "+additionalQuestionDTO.getOption3()+" \\newline ");
			optionList.put("d",additionalQuestionDTO.getOption4());
			wholeQuestion.append("d. "+additionalQuestionDTO.getOption4()+" \\newline ");
			optionList.put("e",additionalQuestionDTO.getOption5());
			wholeQuestion.append("e. "+additionalQuestionDTO.getOption5()+" \\newline ");
