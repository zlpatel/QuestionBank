			...
			<tbody>
				<c:forEach items="${recordList}" var="studentRecord">
					<tr>
						...
						<td class="text-center"><input style="width:100px;" name="Categorical" type="submit" value= "Categorical" title="category based questions details" details" class = "btn btn-info btn-xs" onclick="document.forms[0].method = 'post';document.forms[0].action = 'categoricalRecords/${studentRecord.userName}'; ;return true;"/></td>
