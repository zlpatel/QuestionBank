...
insert into users values("Jane Doe","ee11cbb19052e40b07aac0ca060c23ee","1234567891","2");
insert into users values("John Doe","ee11cbb19052e40b07aac0ca060c23ee","1234567892","1");
select * from users;
delete from users;
drop table users;
